...
mySat.add(Thruster(xr=(-mySat.size[0]/2, 0, 0), thrust_max=100000, axe='xp', name='main'))
...
mySat.controls = {'thruster-main': [(60, 1.), (1650, 0.9), (18000, 0.8), (2550, 0.)],
...
simu.run(duration_max=10, time_max=5000, infos=1/6)
simu.plot()
